// <copyright file="UpdateStuffNoMerge.cs" company="Zizhen Li">
...
{
    public class UpdateStuffNoMerge : Test_UpdateItem
    {
        private int _count;
        ...
        {
            loadoutInstance.UpdateItem(_innerThing, ThingDefOf.Uranium);
            ...
            result =
                ...
                AssertUtility.Expect(_innerThing.Stuff, ThingDefOf.Uranium, nameof(_innerThing.Stuff))
                ;
