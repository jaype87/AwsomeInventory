// <copyright file="DrawGearTab.cs" company="Zizhen Li">
...
namespace AwesomeInventory.Common
{
    ...
    /// </summary>
    public class DrawGearTab : IDrawGearTab
    {
        ...
        /// <inheritdoc/>
        public void RestScrollPosition()
        {
        ...
        /// <inheritdoc/>
        public void DrawJealous(PawnModal selPawn, Rect canvas)
        {
        ...
        /// <inheritdoc/>
        public void DrawGreedy(PawnModal selPawn, Rect canvas)
        {
            // set up rects
