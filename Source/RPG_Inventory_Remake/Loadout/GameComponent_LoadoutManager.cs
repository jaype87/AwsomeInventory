...
namespace RPG_Inventory_Remake.RPGILoadout
{
    public class LoadoutManager : GameComponent
    {
        ...
        {
            return new Loadout("Corgi_EmptyLoadoutName".Translate(), 1) { canBeDeleted = false, defaultLoadout = true };
        }
        ...
        /// </summary>
        /// <param name="pawn">Pawn for whom new List should be stored.</param>
        ...
        {
            return GetUniqueLabel("Corgi_DefaultLoadoutName".Translate());
        }
